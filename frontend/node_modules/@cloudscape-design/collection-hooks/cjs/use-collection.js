...
function useCollection(allItems, options) {
    ...
    const { items, allPageItems, pagesCount, totalItemsCount, filteredItemsCount, actualPageIndex, selectedItems, expandableRows, } = (0, index_js_1.processItems)(allItems, state, options);
    ...
    const filteringOptions = (0, react_1.useMemo)(() => externalFilteringOptions !== null && externalFilteringOptions !== void 0 ? externalFilteringOptions : (0, utils_js_1.computeFilteringOptions)(allItems, filteringProperties), [allItems, filteringProperties, externalFilteringOptions]);
    ...
    return Object.assign({ items,
        allPageItems,
        filteredItemsCount,
        actions }, (0, utils_js_1.createSyncProps)(options, extendedState, actions, collectionRef, {
        actualPageIndex,
        pagesCount,
        allItems,
        totalItemsCount,
