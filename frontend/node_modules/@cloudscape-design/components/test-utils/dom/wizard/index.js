...
class WizardWrapper extends form_1.default {
    ...
    findMenuNavigationLinks() {
        return this.findByClassName(styles_selectors_js_2.default.navigation).findAllByClassName(styles_selectors_js_2.default['navigation-link']);
    }
    /**
    ...
    findMenuNavigationLink(stepNumber, state) {
        ...
        return this.find(`.${styles_selectors_js_2.default.navigation} .${styles_selectors_js_2.default['navigation-link-item']}:nth-child(${stepNumber}) .${styles_selectors_js_2.default['navigation-link']}${additionalClassName}`);
    }
