...
class DropdownWrapper extends selectors_1.ComponentWrapper {
    /**
     ...
     */
    findOpenDropdown(options = {
        expandToViewport: false
    }) {
        const dropdown = options.expandToViewport ? (0, selectors_1.createWrapper)().find(`.${styles_selectors_js_1.default.dropdown}[data-open=true]`) : this.find(`.${styles_selectors_js_1.default.dropdown}[data-open=true]`);
    ...
    isOpen(options = {
        ...
        return options.expandToViewport ? (0, selectors_1.createWrapper)().find(`.${styles_selectors_js_1.default.dropdown}[data-open=true]`) !== null : this.find(`.${styles_selectors_js_1.default.dropdown}[data-open=true]`) !== null;
    }
}
