...
.awsui_drag-overlay-item_1ksmw_1ekcd_149:not(#\9)::before {
  content: " ";
  display: block;
  position: absolute;
...
.awsui_drag-overlay-container_1ksmw_1ekcd_174:not(#\9) {
...
.awsui_drag-overlay-container_1ksmw_1ekcd_174:not(#\9)::before {
  content: " ";
  display: block;
  position: absolute;
  inset-inline-start: calc(-1 * 0px);
...
.awsui_active_1ksmw_1ekcd_200:not(#\9) {
...
.awsui_placeholder_1ksmw_1ekcd_210:not(#\9) {
  position: relative;
}
.awsui_placeholder_1ksmw_1ekcd_210:not(#\9):after {
  content: " ";
  position: absolute;
  inset: 0;
  background: var(--color-drag-placeholder-hover-qwadna, #d1f1ff);
}
.awsui_placeholder-item_1ksmw_1ekcd_219:not(#\9):after {
  border-start-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-start-end-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-start-radius: var(--border-radius-item-iwaia5, 8px);
  border-end-end-radius: var(--border-radius-item-iwaia5, 8px);
}
.awsui_placeholder-container_1ksmw_1ekcd_225:not(#\9):after {
  border-start-start-radius: var(--border-radius-container-nsfwmm, 16px);
  border-start-end-radius: var(--border-radius-container-nsfwmm, 16px);
  border-end-start-radius: var(--border-radius-container-nsfwmm, 16px);
  border-end-end-radius: var(--border-radius-container-nsfwmm, 16px);
...
.awsui_sorting_1ksmw_1ekcd_232:not(#\9) {
...
.awsui-motion-disabled .awsui_sorting_1ksmw_1ekcd_232:not(#\9), .awsui-mode-entering .awsui_sorting_1ksmw_1ekcd_232:not(#\9) {
  animation: none;
  transition: none;
}